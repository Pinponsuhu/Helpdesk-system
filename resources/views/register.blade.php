    ...
    <main class="w-full h-screen overflow-y-scroll">
        ...
        <div class="px-3 md:px-6">
            <div class="mt-4 py-4 px-3 md:px-6 w-full rounded-md bg-white">
                <h1 class="text-xl md:text-2xl font-bold mt-2 uppercase text-gray-800 ml-5">Add New Staff</h1>
                <form action="/register/staff" autocomplete="off" method="post" enctype="multipart/form-data" class="w-80 md:w-9/12 grid md:grid-cols-2 lg:grid-cols-3 gap-x-4 items-center mx-auto md:mt-6 py-4">
                    @csrf
                    ...
                    <div class="my-1 md:my-4">
                        <label class="font-bold block mb-2">Admin</label>
                        <select name="admin"  class="py-3 border-2 border-lime-500 px-3 block w-full bg-white shadow-md" id="">
                    ...
                    <div class="my-1 md:my-4">
                        ...
                        <select name="ticket_permission"  class="py-3 border-2 border-lime-500 px-3 block w-full bg-white shadow-md" id="">
                            <option value="" disabled selected>-- Ticket Permisssion --</option>
                            <option value="1">Yes</option>
                            <option value="0">No</option>
                        </select>
                    ...
                    <button class="md:col-span-2 lg:col-span-3 rounded mx-auto w-32 bg-blue-500 py-3 block text-white font-bold">Register</button>
                </form>
            </div>
        </div>
    </main>
